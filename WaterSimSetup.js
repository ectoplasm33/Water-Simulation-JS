...
influence_radius_slider.style.bottom = pixels(slider_spacing + slider_dy);
influence_radius_label.style.left = pixels(slider_dx + slider_width * 0.5);
influence_radius_label.style.bottom = pixels(slider_spacing + slider_dy + label_dy);
...
gravity_slider.style.bottom = pixels(slider_spacing * 2 + slider_dy);
gravity_label.style.left = pixels(slider_dx + slider_width * 0.5);
gravity_label.style.bottom = pixels(slider_spacing * 2 + slider_dy + label_dy);
...
target_density_slider.style.bottom = pixels(slider_spacing * 3 + slider_dy);
target_density_label.style.left = pixels(slider_dx + slider_width * 0.5);
target_density_label.style.bottom = pixels(slider_spacing * 3 + slider_dy + label_dy);
...
pressure_multiplier_slider.style.bottom = pixels(slider_spacing * 4 + slider_dy);
pressure_multiplier_label.style.left = pixels(slider_dx + slider_width * 0.5);
pressure_multiplier_label.style.bottom = pixels(slider_spacing * 4 + slider_dy + label_dy);
...
viscosity_multiplier_slider.style.bottom = pixels(slider_spacing * 5 + slider_dy);
viscosity_multipler_label.style.left = pixels(slider_dx + slider_width * 0.5);
viscosity_multipler_label.style.bottom = pixels(slider_spacing * 5 + slider_dy + label_dy);
...
surface_tension_slider.style.bottom = pixels(slider_spacing * 6 + slider_dy);
surface_tension_label.style.left = pixels(slider_dx + slider_width * 0.5);
surface_tension_label.style.bottom = pixels(slider_spacing * 6 + slider_dy + label_dy);
...
mouse_range_slider.style.bottom = pixels(slider_spacing * 7 + slider_dy);
mouse_range_label.style.left = pixels(slider_dx + slider_width * 0.5);
mouse_range_label.style.bottom = pixels(slider_spacing * 7 + slider_dy + label_dy);
...
mouse_strength_slider.style.bottom = pixels(slider_spacing * 8 + slider_dy);
mouse_strength_label.style.left = pixels(slider_dx + slider_width * 0.5);
mouse_strength_label.style.bottom = pixels(slider_spacing * 8 + slider_dy + label_dy);
